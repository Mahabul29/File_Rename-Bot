...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton(" ᴅᴇᴠᴇʟᴏᴘᴇʀ ", url='https://telegram.me/Mahabul201')]
    ])
    if Config.START_PIC:
...
async def cb_handler(client, query: CallbackQuery):
    ...
    if data == "start":
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview = True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("  ʀᴇᴘᴏ", url="https://github.com/Mahabul29"),
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview = True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton(" ᴍᴏʀᴇ ʙᴏᴛs", url="https://telegram.me/Hindi_Dub_Animes_Official")],
